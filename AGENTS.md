...
2. **conCierge Slack Bot** (`src/`) — Go bot that opens PRs mutating terraform locals files, posts request summaries to `#concierge`, and records manager/admin approvals via reactions.

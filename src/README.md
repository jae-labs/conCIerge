...
Local development uses Socket Mode by default. For remote deployment, run the same binary with `SLACK_MODE=http` behind nginx and point Slack request URLs at `/slack/events`.
